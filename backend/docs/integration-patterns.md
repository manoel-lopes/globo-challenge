...
> **Module structure**: For module layout and cross-boundary communication rules, see [`.cursor/skills/nestjs-modular-monolith/SKILL.md`](../.cursor/skills/nestjs-modular-monolith/SKILL.md).
